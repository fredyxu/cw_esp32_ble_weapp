...
void update_settings(String item, String value) {
	...
	// 自动按键是否左右交换
		...
		// Serial.println(get_settings("s_auto_key_type"));
	}
	// 是否自动发送
		...
		// Serial.println(get_settings("s_auto_send"));
	}
	// 是否使用触摸电键
